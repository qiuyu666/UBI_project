# -*- coding:utf-8 *-*
# @Time    : 2017/10/22 0022 20:35
# @Author  : LQY
# @File    : friend_analyze.py
...
def friends_statistic():  #统计各个等级的 流失 和 非流失 人数，并写进文件
    level_dic_0={}
    level_dic_1 = {}
    #count=0
    f=open('E:\8-22_Ubi_data\data_analyze\\friends_analyze\\for_7model_friends.csv','r')
    ...
    fw=open('E:\8-22_Ubi_data\data_analyze\\friends_analyze\\for_7model_friends_dic_count_0.txt','w') #_1 表示非流失，改为_0表示流失人数文件
    fw1 = open('E:\8-22_Ubi_data\data_analyze\\friends_analyze\\for_7model_friends_dic_count_1.txt', 'w')  # _1 表示非流失，改为_0表示流失人数文件
    for i in dict_0:
...
def friends_statistic_dis(): #将各个等级的 流失 和非流失 人数画图展示出来
    ...
    flag0=0
    flag1=0
    f= open('E:\8-22_Ubi_data\data_analyze\\friends_analyze\\for_7model_friends_dic_count_0.txt','r')
    f1 = open('E:\8-22_Ubi_data\data_analyze\\friends_analyze\\for_7model_friends_dic_count_1.txt','r')
    for line in f.readlines():
        line= line.split('\t')
        if flag0==1:
            data1.append(line[0])
    ...
    for line in f1.readlines():
        ...
        flag1=1
    #x = range(data.)
    plt.title(u'拥有不同好友数的流失人数-7') #图标名称
    label = [u"流失", u"非流失"]  #标注
    plt.xlabel(u'好友数')    #横坐标名称
    ...
    fig_name = 'E:\8-22_Ubi_data\data_analyze\\friends_analyze\\churn_count' + '\\' + 'churn_count_7_log' + '.png'
