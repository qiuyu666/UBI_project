# -*- coding:utf-8 *-*
# @Time    : 2017/10/22 0022 16:48
# @Author  : LQY
# @File    : kills_analyze.py
...
def kills_statistic():  #统计各个等级的 流失 和 非流失 人数，并写进文件
    level_dic_0={}
    level_dic_1 = {}
    #count=0
    f=open('E:\8-22_Ubi_data\data_analyze\kills_analyze\\for_7model_mean_kills.csv','r')
    ...
    fw=open('E:\8-22_Ubi_data\data_analyze\kills_analyze\\for_7model_kills_dic_count_0.txt','w') #_1 表示非流失，改为_0表示流失人数文件
    fw1 = open('E:\8-22_Ubi_data\data_analyze\kills_analyze\\for_7model_kills_dic_count_1.txt', 'w')  # _1 表示非流失，改为_0表示流失人数文件
    for i in dict_0:
    ...
    #print count
kills_statistic()
def kills_statistic_dis(): #将各个等级的 流失 和非流失 人数画图展示出来
    data1=[]
    data2=[]
    rate_of_users_0=[]
    rate_of_users_1 = []
    flag0=0
    flag1=0
    f= open('E:\8-22_Ubi_data\data_analyze\kills_analyze\\for_7model_kills_dic_count_0.txt','r')
    f1 = open('E:\8-22_Ubi_data\data_analyze\kills_analyze\\for_7model_kills_dic_count_1.txt','r')
    for line in f.readlines():
        line= line.split('\t')
        if flag0==1:
            data1.append(line[0])
    ...
    ax1 = plt.subplot(121)
    plt.title(u'不同杀敌数的流失人数-7')  # 图标名称
    # label = [u"流失", u"非流失"]  #标注
    plt.xlabel(u'平均杀敌数')  # 横坐标名称
    plt.ylabel(u'人数')  # 纵坐标名称

    ax2 = plt.subplot(122)
    plt.title(u'不同杀敌数的非流失人数-7')  # 图标名称
    ...
    fig_name = 'E:\8-22_Ubi_data\data_analyze\\kills_analyze\\churn_count' + '\\' + 'churn_count_7' + '.png'
